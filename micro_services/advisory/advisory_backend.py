...
INTERNAL_SERVICES = {
    "mandi_prices":     os.environ.get("MANDI_PRICES_URL", "http://127.0.0.1:5011"),
    "nearest_mandi":    os.environ.get("NEAREST_MANDI_URL", "http://127.0.0.1:5012"),
    "irrigation":       os.environ.get("IRRIGATION_URL", "http://127.0.0.1:5001"),
    "cold_storage":     os.environ.get("COLD_STORAGE_URL", "http://127.0.0.1:5010"),
}
...
CROP_RECOMMENDER_APIS = {
    "tripura":   os.environ.get("CROP_RECOMMENDER_TRIPURA", "http://127.0.0.1:5003"),
    "meghalaya": os.environ.get("CROP_RECOMMENDER_MEGHALAYA", "http://127.0.0.1:5005"),
    "rajasthan": os.environ.get("CROP_RECOMMENDER_RAJASTHAN", "http://127.0.0.1:5007"),
}
